  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full text-center">
        ...
        <p className="text-gray-600 mb-4 text-base md:text-lg">Thank you for your purchase. Your payment of <b>₹{amount.state.amount}</b> has been processed successfully.</p>
        <a
          href="/"
